...
namespace GameFramework.FairyGUI.Runtime
{
    ...
    /// FairyGUI界面实例
    /// </summary>
    public sealed class FairyGUIForm : IUIForm
    {
        private readonly GComponent m_ContentPane;
        private readonly IUIFormLogic m_UIFormLogic;

        public FairyGUIForm(GComponent contentPane, IUIFormLogic uiFormLogic)
        {
        ...
        {
            GRoot.inst.AddChild(m_ContentPane);
        ...
        {
            m_ContentPane.sortingOrder = uiGroupDepth * 1000 + depthInUIGroup;
